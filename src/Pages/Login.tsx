...
function Login() {
  ...
  useEffect(() => {
    // useEffect 내에서 async 함수를 직접 사용할 수 없으므로, 내부에서 호출하는 helper 함수 사용
  ...
  const handleLogin = () => {
    // 입력한 이메일과 비밀번호와 상태에 설정된 값과 비교하여 로그인 여부 판단
  ...
  return (
    ...
    <div className="flex items-center justify-center h-screen">
      ...
      <form className="w-1/2 p-8 bg-white-200">
        ...
        <button type="button" className="w-full bg-blue-500 text-white p-2 rounded" onClick={handleLogin}>
          로그인
        </button>
